    ...
    <MainLayout title="Welcome Homepage">
      ...
      <div className="h-[150vh]">
        <div className="mx-48 mt-6 text-gray-700">
          ...
          <div className="flex flex-row justify-center">
            <div className="text-center">
              <div className="rounded-full w-48 h-48 bg-sky-500 mt-12 mx-14">
        ...
        <div className="text-justify text-lg mx-48 mt-14 text-gray-700">
          ...
          <p className="mt-4">
            Pertama, kami berusaha untuk mempertahankan tingkat keunggulan dalam
            Bisnis Perhotelan. Kedua, kami mengintegrasikan bisnis perhotelan
            dengan pengetahuan ahli kami tentang teknologi internet. Kami
            memiliki pengalaman lebih dari 10 tahun pada sektor teknologi
            internet dan itu membuat kami optimal dalam membantu setiap klien.
            Ini menjadi hal utama yang telah membuat kami diakui sebagai salah
            satu pemimpin industri terbaru di bidang kami.
          </p>
          <p className="mt-4">
            Ada cara yang lebih baik untuk meningkatkan semua aspek dari proses
            reservasi. Kami ingin memungkinkan akses mudah bagi pelanggan,
            meningkatkan keamanan, memaksimalkan transaksi, dan fokus pada
            kecepatan akses bagi pelanggan potensial secara online.
          </p>
        </div>
      </div>
    </MainLayout>
